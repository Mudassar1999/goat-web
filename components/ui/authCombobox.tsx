...
export function AuthCombobox<TData>({
     data,
     onChange,
     placeholder,
     showFlag,
     ...
     console.log(defaultSelectedValue, "defaultSelectedValue in combo")
     useEffect(() => {
          onSearch?.(query);
     }, [onSearch, query]);
               ...
               <div className="relative w-full selectGender-otr selectGender">
                    <HeadlessCombobox.Button className="relative flex w-full cursor-pointer border-none bg-none text-inherit outline-none">
                         <HeadlessCombobox.Input
                              className={cn(`input selectGender custom-placeholder-color input-bordered w-full`)}
